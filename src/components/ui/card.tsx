...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'border border-border bg-card text-card-foreground shadow-[0_0_10px_hsl(25_100%_50%/0.05),inset_0_1px_0_hsl(32_60%_25%/0.2)] transition-all duration-300',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-lg font-bold leading-none tracking-tight font-mono uppercase',
      className
    )}
    {...props}
  />

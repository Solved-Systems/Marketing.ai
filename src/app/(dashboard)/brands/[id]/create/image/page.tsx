...
export default async function CreateImagePage({ params, searchParams }: CreateImagePageProps) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm text-muted-foreground font-mono mb-1">
                <span className="text-primary">$</span> generate --image --brand={brand.name}
              </div>
              <h2 className="text-2xl font-bold tracking-tight">
                <span className="text-primary">{'//'}</span> CREATE_IMAGE
              </h2>
              <p className="text-muted-foreground text-sm">
                Generate AI-powered images for {brand.name}
              </p>
            </div>
          </div>
        </div>
